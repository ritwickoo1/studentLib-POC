    ...
    <body>
            <header>
                ...
                <div class="nav-box"> 
                    ...
                    <ul class="main-nav">
                        <li><a href="admincheckout.jsp">DashBoard</a></li>
           ...
           <div class="row">
               <div class="box">
                   <%
                       ...
                       ResultSet res = db.getIssuedBook();
                        if(res!=null){
                      %>
                       ...
                       <tr class="table-deco">
                           ...
                           <td><a href="DeleteBooks?bid=<%=res.getString("bno")%>">DELETE</a></td>
                       </tr>
                       
                   </table>
                    <%}}%>
                            
                   <a class="btn btn-borrow" href="#">ADD NEW BOOK</a>
